...
function statusObjToHTML(statusObj) {
	...
	} else if (statusObj.name === 'UP') {
		return '<i class="fa fa-arrow-up telldus-status-icon-on telldus-status-icon"></i> Up';
	} else if (statusObj.name === 'DOWN') {
		return '<i class="fa fa-arrow-down telldus-status-icon-on telldus-status-icon"></i> Down';
	} else if (statusObj.name === 'STOP') {
		return '<i class="fa fa-stop telldus-status-icon-on telldus-status-icon"></i> Stop';
	} else {
		return 'Unknown';
	}
}
